      ...
      <nav class="mx-auto flex max-w-6xl items-center justify-between gap-4">
        ...
        <div class="flex items-center gap-2 sm:gap-3">
          ...
          <router-link
            v-if="showModelPlazaEntry"
            to="/model-plaza"
            class="inline-flex items-center gap-1.5 rounded-lg p-2 text-sm text-[#756b60] transition-colors hover:bg-[#efe3d6] hover:text-[#2b251f] dark:text-[#a8a09a] dark:hover:bg-[#23201c] dark:hover:text-white"
            :title="t('nav.modelPlaza')"
          >
            <Icon name="grid" size="md" />
            <span class="hidden sm:inline">{{ t('nav.modelPlaza') }}</span>
